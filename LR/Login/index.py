...
#Criar Nossa Janela
jan = Tk()
jan.title("Back-End Project - Access Panel")
...
#======== Carregando Imagens ============
logo = PhotoImage(file="LR/Login/icons/logo.png")
...
def Login():
    ...
    try: 
        ...
        messagebox.showinfo(title="Login info", message="Access Denied. Try Again.")
...
def Register():
    ...
    NomeLabel = Label(RightFrame, text="Name: ", font=("Century Gothic", 20), bg="RED", fg="White")
    ...
    def RegisterToDataBase():
        ...
        if (Name == "" and Email == "" and User == "" and Pass == "" or Name == "" and Email == ""):
            messagebox.showerror(title="Register Error", message="Fill all empty fields!")
        else:
            DataBaser.cursor.execute("""
